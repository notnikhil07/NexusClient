...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center flex-col ">
      ...
      <form
        className="flex bg-indigo-400 items-center justify-center flex-col gap-4 md:border p-4 w-full sm:w-[70%] md:w-[50%] lg:w-[30%] rounded border-gray-300 md:shadow-sm"
